...
import com.bhushan.fleetapp.services.EmployeeTypeService;
import com.bhushan.fleetapp.services.JobTitleService;
...
public class EmployeeController {
	...
	public String getEmployees(Model model) {
		...
		model.addAttribute("employeeTypeList", employeeTypeService.getEmployeeTypes());
		model.addAttribute("jobTitleList", jobTitleService.getJobTitles());
