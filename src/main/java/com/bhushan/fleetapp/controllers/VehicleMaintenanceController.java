...
import com.bhushan.fleetapp.services.VehicleMaintenanceService;
...
public class VehicleMaintenanceController {
	...
	public String getVehicleMaintenances(Model model) {
		...
		model.addAttribute("vehicleMaintenanceList", vehicleMaintenanceService.getVehicleMaintenances());
